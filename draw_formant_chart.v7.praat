...
text filename vowels-spanish-male-venezuela-carlos_ruella
choice MaleFemale 1
button Male
button Female
...
if label$ = segment_label$
	...
	# you think should have a fixed number of formants.
        # added by cesine, tried to create tracks for male vs female (lowered values by 200hz) it works, but not sure if its accurate.
	if maleFemale = 1
